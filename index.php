...
<body>
    ...
    <table border="1">
        ...
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/novosti" target="_blank">localhost:8080/rest/novosti</a></td>
            <td>Prikazuje sve novosti u json formatu <br></td>
        </tr>
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/novosti/@id" target="_blank">localhost:8080/rest/novosti/@id</a></td>
            <td>prikazuje jednu novost za unesen @id</td>
        </tr>
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/kategorije" target="_blank">localhost:8080/rest/kategorije</a></td>
